...
.kuico{
    background:url(static/img/coolyun.png) no-repeat;
...
.question{
    background:url(static/img/question.png) no-repeat;
    display: inline-block;
    width:20px;
    height:20px;
    padding-right: 5px;
...
#footer a{
 ...
 .downApk{
  ...
  .introduce{
   ...
   background: url(static/img/question.png) no-repeat 20px;
  text-indent: 20px;
  display: inline-block;
  height: 32px;
  line-height: 32px;
...
#cloud{
  background: url(static/img/cloud.png) repeat;
  width: 100%;
  height: 356px;
  position: absolute;
  bottom: 0px;
 ...
 @-moz-keyframes clouds { 
   ...
   #sky{
  background: url(static/img/sky.png) repeat;
  width: 100%;
  heigth: 462px;
  z-index: -20;
  height: 462px;
...
<body>
    ...
    <div id="middle">
        ...
        <ul style="text-align: center;">
            <li style="font-size: 48px">Super校园</li>

            <li><input class="name" name="userid" placeholder="请输入用户名"></li>
            <li><input type="password" name="password" class="pwd" placeholder="请输入密码"></li>
            <li><button id="login">立即登录</button></li><a id="cre" href="create">立即注册</a>
            <li><span id="err" style="display: inline-block;"></span></li>
        </ul>
    </form>
    </div>
    <div id="footer">
    <a>关于我们@qq &nbsp &nbsp|&nbsp &nbsp</a>
    <a>Copyright © 2020 NG  保留所有权利    吉ICP备110号-1</a>
    </div>
<div id="cloud"></div>
